    ...
    try {
      ...
      const microsipPayments = await this.query<MicrosipPayment>(fbDb, `
        SELECT 
          ...
          DES.DOCTO_ORIGEN_ID AS DOCTO_VE_ID,
        ...
        LEFT JOIN DOCTOS_ENTRE_SIS DES ON DES.DOCTO_DESTINO_ID = C.DOCTO_CC_ID
        LEFT JOIN DOCTOS_VE DV ON DV.DOCTO_VE_ID = DES.DOCTO_ORIGEN_ID
